...
public class RegionToNewSuperblockAction extends VertexSelectionDependantAction {
    ...
    /**
     * Allocate a NewsuperBlock
     *
     * @param parentGraph
     *            the base graph
     * @param selection
     *            the selected blocks
     * @return the allocated new super block (without specific listeners)
     */
    private NewSuperBlock allocateNewSuperBlock(final JavaController controller, final XcosDiagram parentGraph, final Object[] selection) throws ScilabInterpreterManagement.InterpreterException {
        final NewSuperBlock superBlock = (NewSuperBlock) XcosCellFactory.createBlock(INTERFUNCTION_NAME_n);
